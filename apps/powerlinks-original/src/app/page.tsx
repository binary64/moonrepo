			...
			<section className="hero">
				<div className="container">
					...
					<p>
						...
						quickly as possible at a competitive price.
					</p>
					<p>
						If you&apos;re unsure of the best part for your bike we&apos;ll
						advise you according to your requirements – our advice is always
						free! Parts and spares can be purchased at our unit on the Hightown
						Industrial Estate.
					</p>
					<p>
